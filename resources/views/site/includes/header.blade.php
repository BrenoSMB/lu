                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="menu">
                            ...
                            <li class="page-scroll"><a href="#ourteam">Nossa Equipe</a></li>
                            <li class="page-scroll"><a href="#services">Nossos Serviços</a></li>
                            <li class="page-scroll"><a href="#gallery">Portfólio</a></li>
